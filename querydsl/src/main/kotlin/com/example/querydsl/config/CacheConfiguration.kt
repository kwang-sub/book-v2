...
class CacheConfiguration(
    ...
    fun cacheManagerCustomizer(): JCacheManagerCustomizer {
        return JCacheManagerCustomizer { cm ->
            createCache(cm, com.example.querydsl.repository.UserRepository.USERS_BY_LOGIN_CACHE)
            createCache(cm, com.example.querydsl.repository.UserRepository.USERS_BY_EMAIL_CACHE)
            createCache(cm, com.example.querydsl.domain.User::class.java.name)
            createCache(cm, com.example.querydsl.domain.Authority::class.java.name)
            createCache(cm, com.example.querydsl.domain.User::class.java.name + ".authorities")
