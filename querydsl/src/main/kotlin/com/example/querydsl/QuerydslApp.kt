...
import com.example.querydsl.config.ApplicationProperties
import com.example.querydsl.config.CRLFLogConverter
...
class QuerydslApp(private val env: Environment) {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes querydsl.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<QuerydslApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(QuerydslApp::class.java)
